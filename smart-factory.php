    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-0 divide-y sm:divide-y-0 lg:divide-x divide-slate-200/80">
        ...
        <div class="lg:px-5 first:pl-0 last:pr-0 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <h3 class="font-display font-800 text-base text-ink mb-2">
            Low <span class="text-rose-600">Productivity</span>
          </h3>
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Unplanned <span class="text-rose-600 font-500">downtime and inefficient processes reduce</span> overall equipment effectiveness.
          </p>
        </div>
        ...
        <div class="lg:px-5 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Unexpected machine failures cause delays and increase maintenance costs.
          </p>
        </div>
        ...
        <div class="lg:px-5 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Scattered data from machines and systems make it hard to see the big picture.
          </p>
        </div>
        ...
        <div class="lg:px-5 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Lack of visibility leads to unnecessary energy consumption.
          </p>
        </div>
        ...
        <div class="lg:px-5 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Difficult to track production history and ensure quality compliance.
          </p>
        </div>
        ...
        <div class="lg:px-5 pt-6 sm:pt-0 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-slate-500 font-300 leading-relaxed">
            Hard to connect machines, PLCs, and enterprise systems together.
          </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-14 sm:mb-16">
        ...
        <h2 class="font-display font-black text-3xl sm:text-4xl lg:text-5xl text-ink tracking-tight">
          <span class="lang-th">จากงานวิศวกรรม สู่ผลลัพธ์ที่จับต้องได้</span><span class="lang-en">From Engineering to Impact</span>
        </h2>
      </div>
      ...
      <div class="grid lg:grid-cols-12 gap-8 lg:gap-6 items-center">
        ...
        <div class="lg:col-span-3">
          ...
          <h2 class="font-display font-black text-2xl sm:text-3xl lg:text-4xl text-slate-900 tracking-tight leading-tight mb-8">
            <span class="lang-th">แพลตฟอร์มเดียว<br><span class="text-emerald-700">ควบคุมได้ทั้งหมด</span></span>
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4 items-start">
              ...
              <div>
                <h3 class="font-800 text-sm sm:text-base text-slate-900 mb-0.5"><span class="lang-th">ติดตั้งได้ยืดหยุ่น</span><span class="lang-en">Flexible Deployment</span></h3>
                <p class="text-xs text-slate-500 font-400 leading-relaxed"><span class="lang-th">รองรับ Cloud, On-Premise หรือ Hybrid ตามกลยุทธ์ IT</span><span class="lang-en">Run on Cloud, On-Premise or Hybrid to fit your IT strategy.</span></p>
              </div>
            </div>
            <!-- 3. Open & Scalable -->
            <div class="flex gap-4 items-start">
              ...
              <div>
                <h3 class="font-800 text-sm sm:text-base text-slate-900 mb-0.5"><span class="lang-th">เปิดกว้าง &amp; ขยายได้</span><span class="lang-en">Open &amp; Scalable</span></h3>
                <p class="text-xs text-slate-500 font-400 leading-relaxed"><span class="lang-th">Open API และสถาปัตยกรรมโมดูลาร์ ขยายไปกับธุรกิจ</span><span class="lang-en">Open APIs and modular architecture to grow with your business.</span></p>
              </div>
            </div>
            <!-- 4. Secure by Design -->
            <div class="flex gap-4 items-start">
              ...
              <div>
                <h3 class="font-800 text-sm sm:text-base text-slate-900 mb-0.5"><span class="lang-th">ปลอดภัยตั้งแต่การออกแบบ</span><span class="lang-en">Secure by Design</span></h3>
                <p class="text-xs text-slate-500 font-400 leading-relaxed"><span class="lang-th">ความปลอดภัยระดับอุตสาหกรรม ตั้งแต่อุปกรณ์ถึงองค์กร</span><span class="lang-en">Industrial-grade security from device to enterprise.</span></p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="py-20 bg-white border-b border-slate-100">
    <div class="max-w-7xl mx-auto px-6">
      <div class="max-w-2xl mb-12">
        ...
        <h2 class="font-display font-800 text-3xl sm:text-4xl text-ink tracking-tight leading-tight">
          <span class="lang-th">ผลลัพธ์ที่พิสูจน์ได้จากหน้างานจริง</span>
          <span class="lang-en">Proven Results on the Production Floor</span>
        </h2>
      </div>
  ...
  <section class="py-20 bg-ink text-white">
    <div class="max-w-4xl mx-auto px-6 text-center">
      ...
      <h2 class="font-display font-800 text-3xl sm:text-4xl text-white mb-4">
        <span class="lang-th">ยกระดับโรงงานของคุณสู่ Smart Factory</span>
        <span class="lang-en">Elevate Your Plant to a Smart Factory</span>
      </h2>
      <p class="text-white/70 font-300 mb-8 max-w-xl mx-auto text-sm">
        <span class="lang-th">ทีมวิศวกรพร้อมสำรวจหน้างานและออกแบบระบบที่เหมาะสมกับกระบวนการผลิตของคุณ</span>
        <span class="lang-en">Our engineers are ready to survey your site and design a system that fits your production process.</span>
      </p>
      <a href="<?php echo home_url('/'); ?>#contact" class="bg-brand hover:bg-brand-deep text-white font-700 text-xs tracking-wider uppercase px-10 py-4 rounded-xl transition shadow-lg shadow-brand/20 inline-flex items-center gap-2">
        <i class="fa-solid fa-paper-plane"></i><span class="lang-th">ติดต่อทีมวิศวกร</span><span class="lang-en">Contact Our Engineers</span>
      </a>
    </div>
  </section>
