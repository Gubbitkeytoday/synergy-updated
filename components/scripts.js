    ...
    navbarContainer.innerHTML = `
      <nav class="fixed top-0 left-0 right-0 z-[9999] bg-white/95 backdrop-blur-md border-b border-slate-100/80 shadow-[0_2px_15px_rgba(0,0,0,0.015)] transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="${homeHref('#top')}" class="flex items-center group shrink-0 mr-6">
          ...
          <!-- gap-8 plus text-base overflowed the 1280px xl breakpoint, so the nav row
               ran back over the logo. gap-5 and a fixed text-sm keep the same seven links
               inside max-w-7xl; shrink-0 on the logo above means any link added later can
               only push the row, never sit on top of the brand mark. -->
          <div class="hidden xl:flex items-center gap-5 flex-nowrap text-sm font-800 uppercase tracking-wider text-ink">
            ${renderNavLinks()}
            ...
            <a href="${pageHref('contact.html')}" data-contact-link class="bg-brand text-white px-5 py-3 rounded-xl hover:bg-brand-deep transition-all shadow-md shadow-brand/5 font-extrabold text-sm uppercase tracking-wider hover:-translate-y-0.5 duration-200 whitespace-nowrap shrink-0"><span class="lang-th">ติดต่อเรา</span><span class="lang-en">Contact Us</span></a>
          </div>
        ...
        <div id="mobileMenu" class="hidden xl:hidden bg-white border-t border-slate-100/80 shadow-2xl max-h-[85vh] overflow-y-auto">
          <div class="max-w-7xl mx-auto px-6 py-6 flex flex-col gap-5 text-sm sm:text-base font-800 uppercase tracking-wider text-ink">
            ...
            <a href="${pageHref('contact.html')}" data-contact-link class="bg-brand text-white text-center py-4 rounded-xl hover:bg-brand-deep shadow-md font-extrabold text-sm uppercase tracking-wider transition duration-200 mt-2"><span class="lang-th">ติดต่อเรา</span><span class="lang-en">Contact Us</span></a>
          </div>
        </div>
      </nav>
    `;
              ...
              <ul class="space-y-3 text-xs text-white/60">
                <li>
                  <a href="https://maps.app.goo.gl/ktsFRToQJE7mXfyS7" target="_blank" rel="noopener" class="flex gap-2.5 hover:text-white transition-colors" title="Google Maps">
                    ...
                    <span><span class="lang-th">96 หมู่ 1 ต.คลองหนึ่ง อ.คลองหลวง จ.ปทุมธานี 12120</span><span class="lang-en">96 Moo 1, Khlong Nueng, Khlong Luang, Pathum Thani 12120</span></span>
                  </a>
                </li>
                <li>
