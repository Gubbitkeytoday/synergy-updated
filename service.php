...
<!-- LCP candidate: fetch the hero alongside the stylesheet, not after it. -->
<link rel="preload" as="image" href="<?php echo get_template_directory_uri(); ?>/Home.png" fetchpriority="high">
      ...
      <div class="cta__grid">
        ...
        <div class="cta__left">
          ...
          <div class="cta__actions" data-reveal style="--reveal-delay:160ms">
            <button class="btn btn--gold" type="button" data-modal-open>
...
<div class="modal" id="contactModal" role="dialog" aria-modal="true" aria-labelledby="modalTitle" hidden>
  <div class="modal__panel">
    <button class="modal__close" type="button" data-modal-close aria-label="ปิดหน้าต่าง">
      <svg class="i" aria-hidden="true" focusable="false"><use href="#ic-x"></use></svg>
    </button>

    <h2 class="modal__title" id="modalTitle" lang="en">Talk to Our Experts</h2>
    ...
    <p class="form-status" id="formStatus" role="status" aria-live="polite">
      <svg class="i" id="formStatusIcon" aria-hidden="true" focusable="false"><use href="#ic-check-circle"></use></svg>
      <span id="formStatusText"></span>
    </p>

    <form id="contactForm" novalidate>
      <div class="field">
        <label for="fullName">ชื่อ-นามสกุล / Full Name <span class="req" aria-hidden="true">*</span></label>
        <input type="text" id="fullName" name="fullName" autocomplete="name" required
               maxlength="120" enterkeyhint="next"
               aria-describedby="err-fullName" placeholder="สมชาย ใจดี">
        <span class="error" id="err-fullName">กรุณากรอกชื่อ-นามสกุล</span>
      </div>

      <div class="field">
        <label for="email">อีเมลที่ทำงาน / Work Email <span class="req" aria-hidden="true">*</span></label>
        <input type="email" id="email" name="email" autocomplete="email" required
               maxlength="180" inputmode="email" enterkeyhint="next" spellcheck="false"
               aria-describedby="err-email" placeholder="somchai@company.co.th">
        <span class="error" id="err-email">กรุณากรอกอีเมลให้ถูกต้อง</span>
      </div>

      <div class="field">
        <label for="phone">เบอร์โทรศัพท์ / Phone</label>
        <input type="tel" id="phone" name="phone" autocomplete="tel"
               inputmode="tel" maxlength="32" enterkeyhint="next" placeholder="081-234-5678">
      </div>

      <div class="field">
        <label for="stage">ขั้นตอนที่ต้องการให้ช่วย / Where are you now?</label>
      ...
      <div class="field">
        <label for="message">รายละเอียดโครงการ / Project Scope</label>
        <textarea id="message" name="message" rows="4" maxlength="2000" enterkeyhint="enter"
      ...
      <button class="btn btn--gold btn--block" type="submit">
        <svg class="i" aria-hidden="true" focusable="false"><use href="#ic-send"></use></svg>
...
<script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "Syntech Co., Ltd.",
  "description": "End-to-end product development engineering partner — design, prototyping, manufacturing, certification and after-sales support.",
  "url": "https://www.syntech.co.th/",
  "image": "https://www.syntech.co.th/Home.png",
  "makesOffer": [
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "R&D and Product Innovation" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Mechanical Design & Simulation" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Hardware & Software Development" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "PCB Design & PCBA Manufacturing" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Box Build & System Integration" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Testing & Quality Assurance" } },
    { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Certification & Compliance" } },
